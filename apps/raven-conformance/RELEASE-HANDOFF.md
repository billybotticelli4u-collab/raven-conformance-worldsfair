> **HISTORICAL, NON-OPERATIVE.** This handoff describes an internal release recipe and an ancestor delivery bundle that is not in this public repository. The only current public cold-start authority is the root `DEVELOPER.md`.
